...
public class InterfazEmpresaTransporte extends JFrame
{
    ...
    {
        int peso = empresaTransporte.darCapacidadTotalp( );
        JOptionPane.showMessageDialog( this, "La capacidad total de carga es " + peso + " kg.", "Peso Total", JOptionPane.INFORMATION_MESSAGE );
    }
    
    public void darTolalizarConsumo() {
    	double consumo= empresaTransporte.darConmsumoTotal();
    	JOptionPane.showMessageDialog(this , "El consuno total de combustuible es " + consumo +"gal/Km", "Consumo de combustible", JOptionPane.INFORMATION_MESSAGE);
