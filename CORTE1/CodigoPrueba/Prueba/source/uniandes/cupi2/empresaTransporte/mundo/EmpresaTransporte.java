...
public class EmpresaTransporte
{
     ...
     */
    public double darConmsumoTotal() {
    	return camion1.darConsumo() + camion2.darConsumo() + camion3.darConsumo() + camion4.darConsumo();
    }
    
    public int darCapacidadTotalp( )
    {
